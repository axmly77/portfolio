      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            ...
            className="px-6 py-3 border border-[#21262d] text-[#8b949e] font-semibold rounded-lg hover:border-[#8b949e] hover:text-[#e6edf3] transition-colors flex items-center gap-2"
          >
